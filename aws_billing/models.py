...
class BillingRecord(models.Model):
    ...
    linked_account_id = models.BigIntegerField('Linked Account ID', null=True, blank=True)
    operation = models.CharField('Read ACL', null=True, blank=True, max_length=255)
    payer_account_id = models.BigIntegerField('Payer Account ID', null=True, blank=True)
    pricing_plan_id = models.BigIntegerField('Pricing Plan ID', null=True, blank=True)
    ...
    rate_id = models.BigIntegerField('Rate ID', null=True, blank=True)
    ...
    subscription_id = models.BigIntegerField('Subscription ID', null=True, blank=True)
